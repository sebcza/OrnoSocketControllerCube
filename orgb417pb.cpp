...
#define BITS   24
 ...
 unsigned int   ORGB417PB::state = STATE_WAIT_PREAMBLE;
 unsigned long  ORGB417PB::prev_ts = 0;
 unsigned int   ORGB417PB::nibble = 0;
 unsigned int   ORGB417PB::bits = 0;
 unsigned long  ORGB417PB::value = 0;
